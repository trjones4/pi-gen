...
#		2018-10-25 TBJ	Fixed GIF file name swapping for gunmetal vs. normal separators
#
...
if args.gunmetal:
	...
	imageSeparatorOff = PhotoImage(file="piDSKY2-images/SeparatorOn-gunmetal.gif")
